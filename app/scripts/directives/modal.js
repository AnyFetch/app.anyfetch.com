    ...
    link: function(scope) {
      ...
      scope.$watch('documentfull', function(newVal) {
        ...
        if (newVal) {
          ...
          iframe.document.body.innerHTML = '<style>.wrapper{padding:2%}.hlt{background:rgba(255,242,138,.6)}.hlt_active{background:rgba(255,181,96,.6)}body{word-wrap:break-word}</style>';
